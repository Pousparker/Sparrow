        ...
        <div>
            <div class="uk-card uk-card-default uk-card-hover uk-card-body  uk-position-center-left uk-margin-medium-left" style="border-radius: 10px;">
                <ul class="uk-iconnav uk-iconnav-vertical">
                    <li class="uk-margin-down"><a href="../teacher/index" uk-icon="icon: comment"></a></li>
                    <li class="uk-margin-top"><a href="../teacher/image" uk-icon="icon: image"></a></li>
                    <li class="uk-margin-top"><a href="../teacher/get" uk-icon="icon: upload"></a></li>
                    <li class="uk-margin-top"><a href="../teacher/setting" uk-icon="icon: cog"></a></li>
                </ul>
